  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between w-full z-10 gap-8 md:gap-16">
        <div className="ml-[150px] home-content text-center md:text-left md:w-1/2 lg:w-2/5">
        ...
        <div className="absolute bottom-0 right-[40px] pointer-events-none max-w-[480px] max-h-[100vh]">
